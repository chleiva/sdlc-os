...
[private security advisory](https://github.com/chleiva/sdlc-os/security/advisories/new)
(used here only as the one built-in private-contact channel; conduct
reports are not security vulnerabilities) or by contacting a maintainer
